    ...
    return (
      <section className="productDetails">
        ...
        <Link to={"/inventory"}>
          ...
          <h1 className="header__h1">{productValue.name}</h1> 
    ...
    <div className="desktop-div">
      <section className="productDetails__details">
        <div className="row-1">
          <article>
            <h4>ORDERED BY</h4>
            <span>{productValue.ordered}</span>
          </article>
          <article>
        ...
        <article>
          ...
          <article>
            <h4>LOCATION</h4>
            <span>{productValue.location}</span>
          </article>
        </div>
      </section>
...
export default ProductModal;
  ...
  //       });
    ...
    // const product = this.props.product.find(product => {
